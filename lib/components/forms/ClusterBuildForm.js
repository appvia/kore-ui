...
import { Typography, Button, Row, Col, Form, Select, Alert, Card, Radio, List, Table, Modal, message } from 'antd'
    ...
    return (
      <div>
        ...
        <Form {...formConfig} onSubmit={this.handleSubmit}>
          {this.state.selectedCloud ? (
            this.state.providers[this.state.selectedCloud].length === 0 ? <ClusterBuildNotAvailable /> : <ClusterBuildInfo />
          ) : null}
        </Form>
      </div>
    )
